...
Navigate back to the Resource Group Overview. Either navigate directly in the portal or use the following link in the browser bar.
...
Go back to the AKS Cluster. Either navigate directly in the portal or use the following link in the browser bar.
